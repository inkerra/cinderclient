...
class VolumeACLPermissionManager(base.ManagerWithFind):
    ...
    def create(self, volume_id, type, user_or_group_id, access_permission):
        """Create a volume permission.

        :param volume_id: The ID of the volume permission.
        :param type: type of subject (user or group).
        :param user_or_group_id: The ID of the user or the group.
